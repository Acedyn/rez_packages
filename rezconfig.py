# Create environment variable REZ_CONFIG_FILE pointing to this file
...
packages_path = [
    f"{rez_install_dir}/packages",  # packages that contains the source code or binaries
]

# The path that Rez will locally install packages to when rez-build is used
local_packages_path = f"{rez_install_dir}/packages/build"
...
release_packages_path = f"{rez_install_dir}/packages/release"
